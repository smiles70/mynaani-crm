...
The TypeScript file imports `railway/iac`. Install the SDK inside this directory — the repo root is bun-managed and npm at the root is refused by `devEngines`:

```bash
cd .railway && bun install
```
